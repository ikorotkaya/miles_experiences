...
export function Menu() {
  ...
  return (
    <div className="relative flex justify-end">
      ...
      {menuOpen && (
        <div className="menu-dropdown top-full flex items-center absolute right-0 z-10 md:w-96 origin-top-right border-4 text-black md:border-black border-white md:bg-white bg-[#80DCAC] hover:border-white hover:bg-[#80DCAC] py-4 px-4 flex-col">
          <a
